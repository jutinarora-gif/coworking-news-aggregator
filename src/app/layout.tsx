...
export const metadata: Metadata = {
  ...
  description:
    "An editorial dispatch on coworking, cities, and the borderless life — local news by destination, plus coworking industry news, for remote workers deciding where to be.",
};
