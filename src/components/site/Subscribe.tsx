      ...
      <div className="grid grid-cols-1 lg:grid-cols-12">
        <div className="lg:col-span-7 lg:border-r border-paper/15 px-6 sm:px-10 lg:px-14 py-20">
          ...
          <h2 className="mt-6 font-serif text-4xl sm:text-5xl lg:text-6xl leading-[1] tracking-tight">
            Bookmark it. <em className="italic font-light">No inbox required.</em>
          </h2>
        ...
        <div className="lg:col-span-5 px-6 sm:px-10 lg:px-14 py-20 flex items-center">
          <a
            href="/#cities"
            className="inline-flex items-center px-6 py-3 border border-paper bg-paper text-ink font-mono text-[11px] uppercase tracking-[0.22em] hover:bg-transparent hover:text-paper transition-colors duration-300"
          >
            Browse destinations →
          </a>
        </div>
