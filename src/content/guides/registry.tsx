...
export const ALL_GUIDES_META: GuideMeta[] = [
  ...
  { slug: "getting-your-first-reviews", title: "Getting your first reviews", dek: "A founder's guide to building trust early on.", category: "operators", readMins: 6 },
  { slug: "community-management-101", title: "Community management 101", dek: "Keeping members engaged once they've signed up.", category: "operators", readMins: 6 },
...
// once it's written.
const WRITTEN: GuideModule[] = [howToChooseGuide];
