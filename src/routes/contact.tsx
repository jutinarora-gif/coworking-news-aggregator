...
function ContactPage() {
  return (
    <div className="mx-auto max-w-2xl px-6 py-12">
      ...
      <div className="mt-8 rounded-2xl bg-flare p-6 text-flare-ink md:p-8 flex items-center gap-4">
        <div className="h-11 w-11 shrink-0 rounded-xl bg-flare-ink flex items-center justify-center">
          <Mail className="h-5 w-5 text-flare" />
        </div>
        <div>
          <div className="text-xs uppercase tracking-widest opacity-70">Email us</div>
          <a href="mailto:info@coworkingdispatch.com" className="mt-1 block font-display text-xl hover:underline">
      ...
      <div className="mt-10 grid gap-4 sm:grid-cols-2">
        <div className="glass rounded-2xl p-5 hover-glow hover:hover-glow-hover">
